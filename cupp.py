...
def print_cow():
    ...
    print(
        "           \033[1;31m   ||--|| \033[1;m\033[05m*\033[25m\033[1;m      [ KerNix3 | blackfox@protonmail.com ]"
    )
    print(28 * " " + "[ FOX1EN | psyrens@protonmail.com ]\r\n")
...
def version():
    ...
    print("	* Hacked up by KerNix3")
    print("	* http://www.github.com/blackfox-Crtl4\r\n")
